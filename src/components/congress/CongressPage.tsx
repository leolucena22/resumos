...
export default function CongressPage({ congress }: { congress: CongressData }) {
  ...
  const templates = [
    {
      key: "resumoExpandidoComId",
      label: "Resumo Expandido (com Identificação)",
    },
    {
      key: "resumoExpandidoSemId",
      label: "Resumo Expandido (sem Identificação)",
    },
    { key: "apresentacaoOral", label: "Modelo de Apresentação Oral" },
    { key: "eBanner", label: "Modelo de E-Banner" },
  ] as const;

  const FloatingDownloads = ({
    templateUrls,
    colors,
  }: {
    templateUrls: CongressData["templateUrls"];
    colors: CongressData["colors"];
  }) => {
  ...
  return (
    ...
    >
      <main className="flex-grow">
        ...
        <header className="relative py-20 md:py-32 px-4 text-white overflow-hidden">
            ...
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                ...
                >
                  ...
                  <path
                    d="M0,30 Q15,15 30,30 Q45,45 60,30"
                    stroke="white"
                    strokeWidth="1"
                    fill="none"
                    opacity="0.3"
                  />
                  <polygon
                    points="15,10 25,10 20,20"
                    fill="white"
                    opacity="0.2"
                  />
                  <polygon
                    points="35,40 45,40 40,50"
                    fill="white"
                    opacity="0.2"
                  />
                </pattern>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            ></div>
            <div
              className="absolute bottom-32 left-1/4 w-20 h-20 bg-white/5 rounded-full animate-pulse"
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0 9c-5 0-9-4-9-9m9 9c5 0 9-4 9-9m-9 9H3m0 0a9 9 0 019-9"
                    />
                  </svg>
                  <span className="text-white font-semibold text-lg">
                    Submissão On-line
              ...
              <div className="space-y-12">
                {editalSections.map((section) => (
                  ...
                  >
                    ...
                    <div
                      className="tiptap-container prose max-w-none text-gray-700 leading-relaxed"
          ...
          <Section className="py-20 md:py-32 px-4 bg-gray-50">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
                Confira o edital para a publicação de capítulos de livro e saiba
                como participar.
              </p>
              <a
                  ...
                  >
                    ...
                    >
                      <div className="flex-1">
                        <span
                          className="font-bold text-lg md:text-xl leading-relaxed block"
                          style={{ color: colors.text }}
                        >
                          {item.question}
                        </span>
                      ...
                      <div className="flex-shrink-0 ml-4">
                        ...
                        >
                          <ChevronDown
                            ...
                            style={{
                              color:
                                openIndex === index ? "white" : colors.primary,
                            }}
                          />
                        </div>
                      </div>
          ...
          <div className="flex flex-col items-center md:flex-row md:justify-between md:items-center gap-6 md:gap-8">
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="md:hidden text-center">
                ...
                <p className="text-gray-400 text-sm">Conectando conhecimento</p>
              </div>
            </div>
      ...
      <Modal
        ...
        title="Resumo Simples - Exemplo"
      >
        <div className="space-y-4 text-sm text-justify text-gray-700">
          <p>
            <strong>Introdução:</strong> A pandemia de COVID-19 rapidamente
            transformou a prestação de serviços de saúde, acelerando a adoção da
            telemedicina como uma alternativa segura e eficaz para manter a
            continuidade do atendimento primário. Essa mudança radical no modelo
            de assistência levanta questões importantes sobre a qualidade do
            cuidado oferecido e a satisfação dos pacientes em um ambiente
            virtual. Este estudo, portanto, se propõe a investigar profundamente
            os impactos dessa modalidade inovadora na qualidade geral do
            atendimento e na percepção de satisfação dos indivíduos que a
            utilizaram. A compreensão desses fatores é crucial para aprimorar e
            expandir a telemedicina no cenário pós-pandemia.
            <strong> Objetivos:</strong> Os objetivos primários deste trabalho
            foram duplos: primeiro, avaliar a real eficácia da telemedicina na
            oferta de serviços de atendimento primário ao longo do período
            crítico da pandemia; e, segundo, identificar e analisar os diversos
            fatores que influenciaram diretamente a satisfação dos pacientes com
            essa nova forma de consulta e acompanhamento remoto.
            <strong> Metodologia:</strong> Para atingir os objetivos propostos,
            foi conduzido um estudo observacional transversal. A pesquisa
            envolveu uma amostra de 200 pacientes que foram atendidos por meio
            da telemedicina. O período de coleta de dados abrangeu os meses de
            março a setembro de 2020, que marcam o auge da crise sanitária. Um
            questionário previamente validado foi aplicado a esses
            participantes, sendo a ferramenta principal para mensurar tanto os
            níveis de satisfação quanto a percepção de eficácia do atendimento
            remoto recebido.
            <strong> Resultados:</strong> Os achados do estudo são
            encorajadores: uma expressiva maioria de 85% dos pacientes relatou
            satisfação com a experiência do atendimento via telemedicina. Em
            termos de eficiência, observou-se uma notável redução de 60% no
            tempo de espera por consultas, um benefício direto para os usuários.
            Além disso, a telemedicina demonstrou alta capacidade de resolução,
            com 90% dos casos simples sendo solucionados remotamente. No
            entanto, o estudo também apontou desafios significativos: as
            principais limitações incluíram dificuldades de ordem tecnológica,
            que afetaram 15% dos pacientes, destacando a necessidade de
            infraestrutura e suporte aprimorados.
            <strong> Conclusão:</strong> Em suma, a telemedicina provou ser uma
            ferramenta altamente eficaz para a prestação de atendimento
            primário, revelando-se particularmente vantajosa para consultas de
            seguimento e manejo de casos de menor complexidade. Apesar das
            barreiras tecnológicas pontuais, os resultados reforçam seu
            potencial como uma alternativa viável e promissora para expandir o
            acesso aos serviços de saúde, otimizando recursos e proporcionando
            conveniência. A telemedicina, portanto, consolida-se como um pilar
            fundamental e duradouro no futuro da assistência médica.
          </p>
        </div>
      </Modal>
