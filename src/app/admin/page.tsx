...
import GlobalSettingsDialog from './_components/GlobalSettingsDialog';
...
export default function AdminPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                          ...
                          <label className="block text-sm font-medium text-gray-700 mb-2">Qtd. Máx. Autores</label>

                          <input
                            type="number"
                            value={congressInfo.maxAuthors || 5}
                            onChange={(e) => setCongressInfo({ ...congressInfo, maxAuthors: parseInt(e.target.value) || 5 })}
                            disabled={!isEditing}
                            min="1"
      ...
      <GlobalSettingsDialog isOpen={showGlobalSettings} onClose={() => setShowGlobalSettings(false)} />
    </div>
  );
}
